/**
 * 微信公众号《深至科技企业文化》
 * https://mp.weixin.qq.com/s/QcB_Mj_HtXPUVw0ySlct3w
 * 轮播图 URL 来自页面内 picturePageInfoList（与原文一致）。
 */
export const WECHAT_CULTURE_ARTICLE_URL =
  "https://mp.weixin.qq.com/s/QcB_Mj_HtXPUVw0ySlct3w";

/** 文末轮播图（8 张），固定尺寸容器内 object-cover 展示 */
export const WECHAT_CULTURE_CAROUSEL_IMAGES: string[] = [
...
export const WECHAT_CULTURE_VISION_QUOTE =
  "我们的愿景，是让每一个人在健康的长路上，都能拥有专业且温暖的 AI 伙伴长期守护。我们致力于构建下一代智能化的「健康结果管理」体系，将医疗服务从「提供过程」推进至「交付结果」，让每一次健康干预都可追溯、可验证、可优化，最终让精准的个性化医疗以极低的边际成本覆盖每一个人。";
